// src/components/CallMenu.jsx
import React, { useMemo } from 'react';
import { Menu, MenuItem } from '@mui/material';

const CallMenu = React.memo(({ anchorEl, open, onClose, onMenuItemClick, selectedCallId, airCall }) => {
  ...
  return (
    ...
    >
      ...
      {selectedCall.is_archived === true ? (
        ...
        <MenuItem onClick={() => onMenuItemClick('Archive', selectedCallId)}>Archive</MenuItem>
      )}
    </Menu>
  );
});
